                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    <select class="custom-select form-control" name="status" id="status" required>
                                        ...
                                        @php $currentStatus = $user->status @endphp
                                        <option value="pending" {{ old('status', $currentStatus) == 'pending' ? 'selected' : '' }}>pending</option>
                                        <option value="approved" {{ old('status', $currentStatus) == 'approved' ? 'selected' : '' }}>approved</option>
                                        <option value="banned"  {{ old('status', $currentStatus) == 'banned' ? 'selected' : '' }}>banned</option>
                                    ...
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="status">
                                            @if(config('laravelusers.fontAwesomeEnabled'))
                                                ...
                                                @endphp
                                                <i id="status-icon" class="fas fa-circle"     style="color:{{$statusColor}}" aria-hidden="true"></i>


                                            @else
                                                {{ trans('forms.status_label') }}
                                            @endif
                                        </label>
                                    </div>
                                </div>
