            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive users-table" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
                            <table class="table table-striped table-sm data-table text-center">
                                ...
                                <thead class="thead">
                                    <tr>
                                        ...
                                        @endif
                                        <th class="hidden-sm hidden-xs">الحالة</th>

                                        <th class="hidden-sm hidden-xs ">{!! trans('laravelusers::laravelusers.users-table.created') !!}</th>
                                        <th class="hidden-sm hidden-xs ">{!! trans('laravelusers::laravelusers.users-table.updated') !!}</th>
                                            ...
                                            <td class="hidden-sm hidden-xs">
                                                @if($user->status)
                                                    ...
                                                    @else
                                                        @php $badgeClass = 'danger' @endphp
                                                    @endif
                                                        <span class="badge badge-{{$badgeClass}}">{{ $user->status }}</span>
